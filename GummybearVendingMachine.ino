...
#include <Keypad.h>
#include <LiquidCrystal_I2C.h> // Vorher hinzugef�gte LiquidCrystal_I2C Bibliothek einbinden
...
LiquidCrystal_I2C lcd(0x27, 16, 2); //Hier wird festgelegt um was f�r einen Display es sich handelt. In diesem Fall eines mit 16 Zeichen in 2 Zeilen und der HEX-Adresse 0x27. F�r ein vierzeiliges I2C-LCD verwendet man den Code "LiquidCrystal_I2C lcd(0x27, 20, 4)"
#endif /* LCD_TYPE_I2C_16_2 */

#ifdef LCD_TYPE_I2C_20_4
LiquidCrystal_I2C lcd(0x27, 20, 4); //Hier wird festgelegt um was f�r einen Display es sich handelt. In diesem Fall eines mit 16 Zeichen in 2 Zeilen und der HEX-Adresse 0x27. F�r ein vierzeiliges I2C-LCD verwendet man den Code "LiquidCrystal_I2C lcd(0x27, 20, 4)"
